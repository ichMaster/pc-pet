...
├── firmware/
│   └── pc_tamagotchi/            # one Arduino sketch, split into component tabs
│       ├── pc_tamagotchi.ino     # main: setup() + loop()
...
│       ├── pet_audio.ino         # melodies, siren, ambient, voice, heartbeat
│       ├── pet_mood.ino          # mood / character / pressure / ENV logic
